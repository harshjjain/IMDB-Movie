...
package group14final.starwars_stg_0_1;
 ...
 * @status
 */
public class Starwars_stg implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Starwars_stg.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(Starwars_stg.class);
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (Starwars_FieldSeparator != null) {

				this.setProperty("Starwars_FieldSeparator", Starwars_FieldSeparator.toString());

			}

			if (Starwars_File != null) {

				this.setProperty("Starwars_File", Starwars_File.toString());

			}

			if (Starwars_Encoding != null) {

				this.setProperty("Starwars_Encoding", Starwars_Encoding.toString());

			}

			if (Starwars_RowSeparator != null) {

				this.setProperty("Starwars_RowSeparator", Starwars_RowSeparator.toString());

			}

			if (Starwars_Header != null) {

				this.setProperty("Starwars_Header", Starwars_Header.toString());
		...
		public String Starwars_FieldSeparator;

		public String getStarwars_FieldSeparator() {
			return this.Starwars_FieldSeparator;
		}

		public String Starwars_File;

		public String getStarwars_File() {
			return this.Starwars_File;
		}

		public String Starwars_Encoding;

		public String getStarwars_Encoding() {
			return this.Starwars_Encoding;
		}

		public String Starwars_RowSeparator;

		public String getStarwars_RowSeparator() {
			return this.Starwars_RowSeparator;
		}

		public Integer Starwars_Header;

		public Integer getStarwars_Header() {
			return this.Starwars_Header;
		}
	}
	...
	private final String jobName = "Starwars_stg";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Starwars_stg.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class mysqlStruct implements routines.system.IPersistableRow<mysqlStruct> {
		final static byte[] commonByteArrayLock_GROUP14FINAL_Starwars_stg = new byte[0];
		static byte[] commonByteArray_GROUP14FINAL_Starwars_stg = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_GROUP14FINAL_Starwars_stg.length) {
					if (length < 1024 && commonByteArray_GROUP14FINAL_Starwars_stg.length == 0) {
						commonByteArray_GROUP14FINAL_Starwars_stg = new byte[1024];
					} else {
						commonByteArray_GROUP14FINAL_Starwars_stg = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_GROUP14FINAL_Starwars_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_Starwars_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_GROUP14FINAL_Starwars_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_Starwars_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_GROUP14FINAL_Starwars_stg) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "PAU0zT_" + subJobPidCounter.getAndIncrement());
...
// ###############################
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tFileInputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = " + "context.Starwars_File");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1.append("CSV_OPTION" + " = " + "false");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("ROWSEPARATOR" + " = " + "context.Starwars_RowSeparator");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("FIELDSEPARATOR" + " = " + "context.Starwars_FieldSeparator");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1.append("HEADER" + " = " + "context.Starwars_Header");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							...
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("ENCODING" + " = " + "context.Starwars_Encoding");
							log4jParamters_tFileInputDelimited_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tFileInputDelimited_1", "Starwars", "tFileInputDelimited");
					talendJobLogProcess(globalMap);
				}
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = context.Starwars_File;
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(context.Starwars_File,
								context.Starwars_Encoding, context.Starwars_FieldSeparator,
								context.Starwars_RowSeparator, false, context.Starwars_Header, 0,
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "row1", "tFileInputDelimited_1", "Starwars", "tFileInputDelimited", "tMap_1",
									"tMap_1", "tMap"
...
// Start of branch "mysql"
					...
					if (!((Object) (context.Starwars_File) instanceof java.io.InputStream)) {
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tFileInputDelimited_1", "Starwars", "tFileInputDelimited", "tMap_1", "tMap_1", "tMap",
						"output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "dvGtpa_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final Starwars_stg Starwars_stgClass = new Starwars_stg();

		int exitCode = Starwars_stgClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Starwars_stg' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'Starwars_stg' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_aAiEYJAMEe6a__awYeGrfA");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-03T02:12:37.999032900Z");
		...
		try {
			...
			java.io.InputStream inContext = Starwars_stg.class.getClassLoader()
					.getResourceAsStream("group14final/starwars_stg_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Starwars_stg.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					...
					context.setContextType("Starwars_FieldSeparator", "id_String");
					if (context.getStringValue("Starwars_FieldSeparator") == null) {
						context.Starwars_FieldSeparator = null;
					} else {
						context.Starwars_FieldSeparator = (String) context.getProperty("Starwars_FieldSeparator");
					}
					context.setContextType("Starwars_File", "id_File");
					if (context.getStringValue("Starwars_File") == null) {
						context.Starwars_File = null;
					} else {
						context.Starwars_File = (String) context.getProperty("Starwars_File");
					}
					context.setContextType("Starwars_Encoding", "id_String");
					if (context.getStringValue("Starwars_Encoding") == null) {
						context.Starwars_Encoding = null;
					} else {
						context.Starwars_Encoding = (String) context.getProperty("Starwars_Encoding");
					}
					context.setContextType("Starwars_RowSeparator", "id_String");
					if (context.getStringValue("Starwars_RowSeparator") == null) {
						context.Starwars_RowSeparator = null;
					} else {
						context.Starwars_RowSeparator = (String) context.getProperty("Starwars_RowSeparator");
					}
					context.setContextType("Starwars_Header", "id_Integer");
					if (context.getStringValue("Starwars_Header") == null) {
						context.Starwars_Header = null;
					} else {
						try {
							context.Starwars_Header = routines.system.ParserUtils
									.parseTo_Integer(context.getProperty("Starwars_Header"));
						} catch (NumberFormatException e) {
							log.warn(String.format("Null value will be used for context parameter %s: %s",
									"Starwars_Header", e.getMessage()));
							context.Starwars_Header = null;
						}
					}
				}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("Starwars_FieldSeparator")) {
				context.Starwars_FieldSeparator = (String) parentContextMap.get("Starwars_FieldSeparator");
			}
			if (parentContextMap.containsKey("Starwars_File")) {
				context.Starwars_File = (String) parentContextMap.get("Starwars_File");
			}
			if (parentContextMap.containsKey("Starwars_Encoding")) {
				context.Starwars_Encoding = (String) parentContextMap.get("Starwars_Encoding");
			}
			if (parentContextMap.containsKey("Starwars_RowSeparator")) {
				context.Starwars_RowSeparator = (String) parentContextMap.get("Starwars_RowSeparator");
			}
			if (parentContextMap.containsKey("Starwars_Header")) {
				context.Starwars_Header = (Integer) parentContextMap.get("Starwars_Header");
			}
		}
		...
		log.info("TalendJob: 'Starwars_stg' - Started.");
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Starwars_stg");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'Starwars_stg' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 129453 characters generated by Talend Cloud Data Fabric on the December 2,
 * 2023 at 9:12:37 PM EST
 ************************************************************************************************/