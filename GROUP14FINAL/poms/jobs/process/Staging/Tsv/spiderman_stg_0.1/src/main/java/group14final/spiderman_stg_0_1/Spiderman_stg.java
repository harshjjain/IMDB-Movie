...
package group14final.spiderman_stg_0_1;
 ...
 * @status
 */
public class Spiderman_stg implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Spiderman_stg.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(Spiderman_stg.class);
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (Spiderman_Encoding != null) {

				this.setProperty("Spiderman_Encoding", Spiderman_Encoding.toString());

			}

			if (Spiderman_RowSeparator != null) {

				this.setProperty("Spiderman_RowSeparator", Spiderman_RowSeparator.toString());

			}

			if (Spiderman_File != null) {

				this.setProperty("Spiderman_File", Spiderman_File.toString());

			}

			if (Spiderman_Header != null) {

				this.setProperty("Spiderman_Header", Spiderman_Header.toString());

			}

			if (Spiderman_FieldSeparator != null) {

				this.setProperty("Spiderman_FieldSeparator", Spiderman_FieldSeparator.toString());
		...
		public String Spiderman_Encoding;

		public String getSpiderman_Encoding() {
			return this.Spiderman_Encoding;
		}

		public String Spiderman_RowSeparator;

		public String getSpiderman_RowSeparator() {
			return this.Spiderman_RowSeparator;
		}

		public String Spiderman_File;

		public String getSpiderman_File() {
			return this.Spiderman_File;
		}

		public Integer Spiderman_Header;

		public Integer getSpiderman_Header() {
			return this.Spiderman_Header;
		}

		public String Spiderman_FieldSeparator;

		public String getSpiderman_FieldSeparator() {
			return this.Spiderman_FieldSeparator;
		}
	}
	...
	private final String jobName = "Spiderman_stg";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Spiderman_stg.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Spiderman_stg.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class mysqlStruct implements routines.system.IPersistableRow<mysqlStruct> {
		final static byte[] commonByteArrayLock_GROUP14FINAL_Spiderman_stg = new byte[0];
		static byte[] commonByteArray_GROUP14FINAL_Spiderman_stg = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_GROUP14FINAL_Spiderman_stg.length) {
					if (length < 1024 && commonByteArray_GROUP14FINAL_Spiderman_stg.length == 0) {
						commonByteArray_GROUP14FINAL_Spiderman_stg = new byte[1024];
					} else {
						commonByteArray_GROUP14FINAL_Spiderman_stg = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_GROUP14FINAL_Spiderman_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_Spiderman_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_GROUP14FINAL_Spiderman_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_Spiderman_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_GROUP14FINAL_Spiderman_stg) {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		public Boolean tcontIsNullable() {
			return true;
		}

		public Boolean tcontIsKey() {
			return false;
		}

		public Integer tcontLength() {
			return 10;
		}

		public Integer tcontPrecision() {
			return 0;
		}

		public String tcontDefault() {

			return null;

		}

		public String tcontComment() {

			return "";

		}

		public String tcontPattern() {

			return "dd-MM-yyyy";

		}

		public String tcontOriginalDbColumnName() {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "wrXWOQ_" + subJobPidCounter.getAndIncrement());
...
// ###############################
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tFileInputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = " + "context.Spiderman_File");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1.append("CSV_OPTION" + " = " + "false");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("ROWSEPARATOR" + " = " + "context.Spiderman_RowSeparator");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("FIELDSEPARATOR" + " = " + "context.Spiderman_FieldSeparator");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1.append("HEADER" + " = " + "context.Spiderman_Header");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							...
							log4jParamters_tFileInputDelimited_1.append("TRIMSELECT" + " = " + "[{TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("tcont") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
							...
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("ENCODING" + " = " + "context.Spiderman_Encoding");
							log4jParamters_tFileInputDelimited_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tFileInputDelimited_1", "Spiderman", "tFileInputDelimited");
					talendJobLogProcess(globalMap);
				}
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = context.Spiderman_File;
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.Spiderman_File, context.Spiderman_Encoding, context.Spiderman_FieldSeparator,
								context.Spiderman_RowSeparator, false, context.Spiderman_Header, 0,
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.tcont = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "row1", "tFileInputDelimited_1", "Spiderman", "tFileInputDelimited", "tMap_1",
									"tMap_1", "tMap"
...
// Start of branch "mysql"
					...
					if (!((Object) (context.Spiderman_File) instanceof java.io.InputStream)) {
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tFileInputDelimited_1", "Spiderman", "tFileInputDelimited", "tMap_1", "tMap_1", "tMap",
						"output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "ZZGYCy_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final Spiderman_stg Spiderman_stgClass = new Spiderman_stg();

		int exitCode = Spiderman_stgClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Spiderman_stg' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'Spiderman_stg' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_WPpMsJAMEe6a__awYeGrfA");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-03T02:12:28.183210200Z");
		...
		try {
			...
			java.io.InputStream inContext = Spiderman_stg.class.getClassLoader()
					.getResourceAsStream("group14final/spiderman_stg_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Spiderman_stg.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					...
					context.setContextType("Spiderman_Encoding", "id_String");
					if (context.getStringValue("Spiderman_Encoding") == null) {
						context.Spiderman_Encoding = null;
					} else {
						context.Spiderman_Encoding = (String) context.getProperty("Spiderman_Encoding");
					}
					context.setContextType("Spiderman_RowSeparator", "id_String");
					if (context.getStringValue("Spiderman_RowSeparator") == null) {
						context.Spiderman_RowSeparator = null;
					} else {
						context.Spiderman_RowSeparator = (String) context.getProperty("Spiderman_RowSeparator");
					}
					context.setContextType("Spiderman_File", "id_File");
					if (context.getStringValue("Spiderman_File") == null) {
						context.Spiderman_File = null;
					} else {
						context.Spiderman_File = (String) context.getProperty("Spiderman_File");
					}
					context.setContextType("Spiderman_Header", "id_Integer");
					if (context.getStringValue("Spiderman_Header") == null) {
						context.Spiderman_Header = null;
					} else {
						try {
							context.Spiderman_Header = routines.system.ParserUtils
									.parseTo_Integer(context.getProperty("Spiderman_Header"));
						} catch (NumberFormatException e) {
							log.warn(String.format("Null value will be used for context parameter %s: %s",
									"Spiderman_Header", e.getMessage()));
							context.Spiderman_Header = null;
						}
					}
					context.setContextType("Spiderman_FieldSeparator", "id_String");
					if (context.getStringValue("Spiderman_FieldSeparator") == null) {
						context.Spiderman_FieldSeparator = null;
					} else {
						context.Spiderman_FieldSeparator = (String) context.getProperty("Spiderman_FieldSeparator");
					}
				}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("Spiderman_Encoding")) {
				context.Spiderman_Encoding = (String) parentContextMap.get("Spiderman_Encoding");
			}
			if (parentContextMap.containsKey("Spiderman_RowSeparator")) {
				context.Spiderman_RowSeparator = (String) parentContextMap.get("Spiderman_RowSeparator");
			}
			if (parentContextMap.containsKey("Spiderman_File")) {
				context.Spiderman_File = (String) parentContextMap.get("Spiderman_File");
			}
			if (parentContextMap.containsKey("Spiderman_Header")) {
				context.Spiderman_Header = (Integer) parentContextMap.get("Spiderman_Header");
			}
			if (parentContextMap.containsKey("Spiderman_FieldSeparator")) {
				context.Spiderman_FieldSeparator = (String) parentContextMap.get("Spiderman_FieldSeparator");
			}
		}
		...
		log.info("TalendJob: 'Spiderman_stg' - Started.");
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Spiderman_stg");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'Spiderman_stg' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 129578 characters generated by Talend Cloud Data Fabric on the December 2,
 * 2023 at 9:12:28 PM EST
 ************************************************************************************************/