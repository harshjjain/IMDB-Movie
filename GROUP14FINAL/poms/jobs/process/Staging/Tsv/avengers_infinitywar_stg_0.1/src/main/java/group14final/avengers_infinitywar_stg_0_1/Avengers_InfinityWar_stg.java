...
package group14final.avengers_infinitywar_stg_0_1;
...
/**
 * Job: Avengers_InfinityWar_stg Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Avengers_InfinityWar_stg implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Avengers_InfinityWar_stg.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(Avengers_InfinityWar_stg.class);
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (Avengers_InfinityWar_File != null) {

				this.setProperty("Avengers_InfinityWar_File", Avengers_InfinityWar_File.toString());

			}

			if (Avengers_InfinityWar_Encoding != null) {

				this.setProperty("Avengers_InfinityWar_Encoding", Avengers_InfinityWar_Encoding.toString());

			}

			if (Avengers_InfinityWar_RowSeparator != null) {

				this.setProperty("Avengers_InfinityWar_RowSeparator", Avengers_InfinityWar_RowSeparator.toString());

			}

			if (Avengers_InfinityWar_FieldSeparator != null) {

				this.setProperty("Avengers_InfinityWar_FieldSeparator", Avengers_InfinityWar_FieldSeparator.toString());

			}

			if (Avengers_InfinityWar_Header != null) {

				this.setProperty("Avengers_InfinityWar_Header", Avengers_InfinityWar_Header.toString());
		...
		public String Avengers_InfinityWar_File;

		public String getAvengers_InfinityWar_File() {
			return this.Avengers_InfinityWar_File;
		}

		public String Avengers_InfinityWar_Encoding;

		public String getAvengers_InfinityWar_Encoding() {
			return this.Avengers_InfinityWar_Encoding;
		}

		public String Avengers_InfinityWar_RowSeparator;

		public String getAvengers_InfinityWar_RowSeparator() {
			return this.Avengers_InfinityWar_RowSeparator;
		}

		public String Avengers_InfinityWar_FieldSeparator;

		public String getAvengers_InfinityWar_FieldSeparator() {
			return this.Avengers_InfinityWar_FieldSeparator;
		}

		public Integer Avengers_InfinityWar_Header;

		public Integer getAvengers_InfinityWar_Header() {
			return this.Avengers_InfinityWar_Header;
		}
	...
	private final String jobName = "Avengers_InfinityWar_stg";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Avengers_InfinityWar_stg.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Avengers_InfinityWar_stg.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class mysqlStruct implements routines.system.IPersistableRow<mysqlStruct> {
		final static byte[] commonByteArrayLock_GROUP14FINAL_Avengers_InfinityWar_stg = new byte[0];
		static byte[] commonByteArray_GROUP14FINAL_Avengers_InfinityWar_stg = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_GROUP14FINAL_Avengers_InfinityWar_stg.length) {
					if (length < 1024 && commonByteArray_GROUP14FINAL_Avengers_InfinityWar_stg.length == 0) {
						commonByteArray_GROUP14FINAL_Avengers_InfinityWar_stg = new byte[1024];
					} else {
						commonByteArray_GROUP14FINAL_Avengers_InfinityWar_stg = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_GROUP14FINAL_Avengers_InfinityWar_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_Avengers_InfinityWar_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_GROUP14FINAL_Avengers_InfinityWar_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_Avengers_InfinityWar_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_GROUP14FINAL_Avengers_InfinityWar_stg) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "IgPbZj_" + subJobPidCounter.getAndIncrement());
...
// ###############################
					...
					class BytesLimit65535_tFileInputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_1
									.append("FILENAME" + " = " + "context.Avengers_InfinityWar_File");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1.append("CSV_OPTION" + " = " + "false");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("ROWSEPARATOR" + " = " + "context.Avengers_InfinityWar_RowSeparator");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("FIELDSEPARATOR" + " = " + "context.Avengers_InfinityWar_FieldSeparator");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("HEADER" + " = " + "context.Avengers_InfinityWar_Header");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							...
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("ENCODING" + " = " + "context.Avengers_InfinityWar_Encoding");
							log4jParamters_tFileInputDelimited_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tFileInputDelimited_1", "Avengers_InfinityWar", "tFileInputDelimited");
					talendJobLogProcess(globalMap);
				}
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = context.Avengers_InfinityWar_File;
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.Avengers_InfinityWar_File, context.Avengers_InfinityWar_Encoding,
								context.Avengers_InfinityWar_FieldSeparator, context.Avengers_InfinityWar_RowSeparator,
								false, context.Avengers_InfinityWar_Header, 0, limit_tFileInputDelimited_1, -1, false);
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "row1", "tFileInputDelimited_1", "Avengers_InfinityWar", "tFileInputDelimited",
									"tMap_1", "tMap_1", "tMap"
...
// Start of branch "mysql"
					...
					if (!((Object) (context.Avengers_InfinityWar_File) instanceof java.io.InputStream)) {
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tFileInputDelimited_1", "Avengers_InfinityWar", "tFileInputDelimited", "tMap_1", "tMap_1",
						"tMap", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "hABYjC_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final Avengers_InfinityWar_stg Avengers_InfinityWar_stgClass = new Avengers_InfinityWar_stg();

		int exitCode = Avengers_InfinityWar_stgClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Avengers_InfinityWar_stg' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'Avengers_InfinityWar_stg' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_Qov1oJAMEe6a__awYeGrfA");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-03T02:12:03.050385Z");
		...
		try {
			...
			java.io.InputStream inContext = Avengers_InfinityWar_stg.class.getClassLoader().getResourceAsStream(
					"group14final/avengers_infinitywar_stg_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Avengers_InfinityWar_stg.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					context.setContextType("Avengers_InfinityWar_File", "id_File");
					if (context.getStringValue("Avengers_InfinityWar_File") == null) {
						context.Avengers_InfinityWar_File = null;
					} else {
						context.Avengers_InfinityWar_File = (String) context.getProperty("Avengers_InfinityWar_File");
					}
					context.setContextType("Avengers_InfinityWar_Encoding", "id_String");
					if (context.getStringValue("Avengers_InfinityWar_Encoding") == null) {
						context.Avengers_InfinityWar_Encoding = null;
					} else {
						context.Avengers_InfinityWar_Encoding = (String) context
								.getProperty("Avengers_InfinityWar_Encoding");
					}
					context.setContextType("Avengers_InfinityWar_RowSeparator", "id_String");
					if (context.getStringValue("Avengers_InfinityWar_RowSeparator") == null) {
						context.Avengers_InfinityWar_RowSeparator = null;
					} else {
						context.Avengers_InfinityWar_RowSeparator = (String) context
								.getProperty("Avengers_InfinityWar_RowSeparator");
					}
					context.setContextType("Avengers_InfinityWar_FieldSeparator", "id_String");
					if (context.getStringValue("Avengers_InfinityWar_FieldSeparator") == null) {
						context.Avengers_InfinityWar_FieldSeparator = null;
					} else {
						context.Avengers_InfinityWar_FieldSeparator = (String) context
								.getProperty("Avengers_InfinityWar_FieldSeparator");
					}
					context.setContextType("Avengers_InfinityWar_Header", "id_Integer");
					if (context.getStringValue("Avengers_InfinityWar_Header") == null) {
						context.Avengers_InfinityWar_Header = null;
					} else {
						try {
							context.Avengers_InfinityWar_Header = routines.system.ParserUtils
									.parseTo_Integer(context.getProperty("Avengers_InfinityWar_Header"));
						} catch (NumberFormatException e) {
							log.warn(String.format("Null value will be used for context parameter %s: %s",
									"Avengers_InfinityWar_Header", e.getMessage()));
							context.Avengers_InfinityWar_Header = null;
						}
					}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("Avengers_InfinityWar_File")) {
				context.Avengers_InfinityWar_File = (String) parentContextMap.get("Avengers_InfinityWar_File");
			}
			if (parentContextMap.containsKey("Avengers_InfinityWar_Encoding")) {
				context.Avengers_InfinityWar_Encoding = (String) parentContextMap.get("Avengers_InfinityWar_Encoding");
			}
			if (parentContextMap.containsKey("Avengers_InfinityWar_RowSeparator")) {
				context.Avengers_InfinityWar_RowSeparator = (String) parentContextMap
						.get("Avengers_InfinityWar_RowSeparator");
			}
			if (parentContextMap.containsKey("Avengers_InfinityWar_FieldSeparator")) {
				context.Avengers_InfinityWar_FieldSeparator = (String) parentContextMap
						.get("Avengers_InfinityWar_FieldSeparator");
			}
			if (parentContextMap.containsKey("Avengers_InfinityWar_Header")) {
				context.Avengers_InfinityWar_Header = (Integer) parentContextMap.get("Avengers_InfinityWar_Header");
			}
		...
		log.info("TalendJob: 'Avengers_InfinityWar_stg' - Started.");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Avengers_InfinityWar_stg");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'Avengers_InfinityWar_stg' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 131190 characters generated by Talend Cloud Data Fabric on the December 2,
 * 2023 at 9:12:03 PM EST
 ************************************************************************************************/