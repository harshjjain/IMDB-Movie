...
package group14final.avengers_endgame_stg_0_1;
...
/**
 * Job: Avengers_Endgame_stg Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Avengers_Endgame_stg implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Avengers_Endgame_stg.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(Avengers_Endgame_stg.class);
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (Avengers_Endgame_File != null) {

				this.setProperty("Avengers_Endgame_File", Avengers_Endgame_File.toString());

			}

			if (Avengers_Endgame_Encoding != null) {

				this.setProperty("Avengers_Endgame_Encoding", Avengers_Endgame_Encoding.toString());

			}

			if (Avengers_Endgame_RowSeparator != null) {

				this.setProperty("Avengers_Endgame_RowSeparator", Avengers_Endgame_RowSeparator.toString());

			}

			if (Avengers_Endgame_FieldSeparator != null) {

				this.setProperty("Avengers_Endgame_FieldSeparator", Avengers_Endgame_FieldSeparator.toString());

			}

			if (Avengers_Endgame_Header != null) {

				this.setProperty("Avengers_Endgame_Header", Avengers_Endgame_Header.toString());
		...
		public String Avengers_Endgame_File;

		public String getAvengers_Endgame_File() {
			return this.Avengers_Endgame_File;
		}

		public String Avengers_Endgame_Encoding;

		public String getAvengers_Endgame_Encoding() {
			return this.Avengers_Endgame_Encoding;
		}

		public String Avengers_Endgame_RowSeparator;

		public String getAvengers_Endgame_RowSeparator() {
			return this.Avengers_Endgame_RowSeparator;
		}

		public String Avengers_Endgame_FieldSeparator;

		public String getAvengers_Endgame_FieldSeparator() {
			return this.Avengers_Endgame_FieldSeparator;
		}

		public Integer Avengers_Endgame_Header;

		public Integer getAvengers_Endgame_Header() {
			return this.Avengers_Endgame_Header;
		}
	...
	private final String jobName = "Avengers_Endgame_stg";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Avengers_Endgame_stg.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Avengers_Endgame_stg.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class mysqlStruct implements routines.system.IPersistableRow<mysqlStruct> {
		final static byte[] commonByteArrayLock_GROUP14FINAL_Avengers_Endgame_stg = new byte[0];
		static byte[] commonByteArray_GROUP14FINAL_Avengers_Endgame_stg = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_GROUP14FINAL_Avengers_Endgame_stg.length) {
					if (length < 1024 && commonByteArray_GROUP14FINAL_Avengers_Endgame_stg.length == 0) {
						commonByteArray_GROUP14FINAL_Avengers_Endgame_stg = new byte[1024];
					} else {
						commonByteArray_GROUP14FINAL_Avengers_Endgame_stg = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_GROUP14FINAL_Avengers_Endgame_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_Avengers_Endgame_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_GROUP14FINAL_Avengers_Endgame_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_Avengers_Endgame_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_GROUP14FINAL_Avengers_Endgame_stg) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "17XpwS_" + subJobPidCounter.getAndIncrement());
...
// ###############################
					...
					class BytesLimit65535_tFileInputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_1
									.append("FILENAME" + " = " + "context.Avengers_Endgame_File");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1.append("CSV_OPTION" + " = " + "false");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("ROWSEPARATOR" + " = " + "context.Avengers_Endgame_RowSeparator");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("FIELDSEPARATOR" + " = " + "context.Avengers_Endgame_FieldSeparator");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("HEADER" + " = " + "context.Avengers_Endgame_Header");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							...
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("ENCODING" + " = " + "context.Avengers_Endgame_Encoding");
							log4jParamters_tFileInputDelimited_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tFileInputDelimited_1", "Avengers_Endgame", "tFileInputDelimited");
					talendJobLogProcess(globalMap);
				}
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = context.Avengers_Endgame_File;
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.Avengers_Endgame_File, context.Avengers_Endgame_Encoding,
								context.Avengers_Endgame_FieldSeparator, context.Avengers_Endgame_RowSeparator, false,
								context.Avengers_Endgame_Header, 0, limit_tFileInputDelimited_1, -1, false);
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "row1", "tFileInputDelimited_1", "Avengers_Endgame", "tFileInputDelimited",
									"tMap_1", "tMap_1", "tMap"
...
// Start of branch "mysql"
					...
					if (!((Object) (context.Avengers_Endgame_File) instanceof java.io.InputStream)) {
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tFileInputDelimited_1", "Avengers_Endgame", "tFileInputDelimited", "tMap_1", "tMap_1", "tMap",
						"output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "vAU1G8_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final Avengers_Endgame_stg Avengers_Endgame_stgClass = new Avengers_Endgame_stg();

		int exitCode = Avengers_Endgame_stgClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Avengers_Endgame_stg' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'Avengers_Endgame_stg' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_UYIjYJAKEe6a__awYeGrfA");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-03T02:11:53.397729800Z");
		...
		try {
			...
			java.io.InputStream inContext = Avengers_Endgame_stg.class.getClassLoader().getResourceAsStream(
					"group14final/avengers_endgame_stg_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Avengers_Endgame_stg.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					context.setContextType("Avengers_Endgame_File", "id_File");
					if (context.getStringValue("Avengers_Endgame_File") == null) {
						context.Avengers_Endgame_File = null;
					} else {
						context.Avengers_Endgame_File = (String) context.getProperty("Avengers_Endgame_File");
					}
					context.setContextType("Avengers_Endgame_Encoding", "id_String");
					if (context.getStringValue("Avengers_Endgame_Encoding") == null) {
						context.Avengers_Endgame_Encoding = null;
					} else {
						context.Avengers_Endgame_Encoding = (String) context.getProperty("Avengers_Endgame_Encoding");
					}
					context.setContextType("Avengers_Endgame_RowSeparator", "id_String");
					if (context.getStringValue("Avengers_Endgame_RowSeparator") == null) {
						context.Avengers_Endgame_RowSeparator = null;
					} else {
						context.Avengers_Endgame_RowSeparator = (String) context
								.getProperty("Avengers_Endgame_RowSeparator");
					}
					context.setContextType("Avengers_Endgame_FieldSeparator", "id_String");
					if (context.getStringValue("Avengers_Endgame_FieldSeparator") == null) {
						context.Avengers_Endgame_FieldSeparator = null;
					} else {
						context.Avengers_Endgame_FieldSeparator = (String) context
								.getProperty("Avengers_Endgame_FieldSeparator");
					}
					context.setContextType("Avengers_Endgame_Header", "id_Integer");
					if (context.getStringValue("Avengers_Endgame_Header") == null) {
						context.Avengers_Endgame_Header = null;
					} else {
						try {
							context.Avengers_Endgame_Header = routines.system.ParserUtils
									.parseTo_Integer(context.getProperty("Avengers_Endgame_Header"));
						} catch (NumberFormatException e) {
							log.warn(String.format("Null value will be used for context parameter %s: %s",
									"Avengers_Endgame_Header", e.getMessage()));
							context.Avengers_Endgame_Header = null;
						}
					}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("Avengers_Endgame_File")) {
				context.Avengers_Endgame_File = (String) parentContextMap.get("Avengers_Endgame_File");
			}
			if (parentContextMap.containsKey("Avengers_Endgame_Encoding")) {
				context.Avengers_Endgame_Encoding = (String) parentContextMap.get("Avengers_Endgame_Encoding");
			}
			if (parentContextMap.containsKey("Avengers_Endgame_RowSeparator")) {
				context.Avengers_Endgame_RowSeparator = (String) parentContextMap.get("Avengers_Endgame_RowSeparator");
			}
			if (parentContextMap.containsKey("Avengers_Endgame_FieldSeparator")) {
				context.Avengers_Endgame_FieldSeparator = (String) parentContextMap
						.get("Avengers_Endgame_FieldSeparator");
			}
			if (parentContextMap.containsKey("Avengers_Endgame_Header")) {
				context.Avengers_Endgame_Header = (Integer) parentContextMap.get("Avengers_Endgame_Header");
			}
		...
		log.info("TalendJob: 'Avengers_Endgame_stg' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Avengers_Endgame_stg");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'Avengers_Endgame_stg' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 130614 characters generated by Talend Cloud Data Fabric on the December 2,
 * 2023 at 9:11:53 PM EST
 ************************************************************************************************/