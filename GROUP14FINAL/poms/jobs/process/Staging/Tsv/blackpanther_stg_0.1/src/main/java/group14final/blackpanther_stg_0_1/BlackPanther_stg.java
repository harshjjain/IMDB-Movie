...
package group14final.blackpanther_stg_0_1;
...
/**
 * Job: BlackPanther_stg Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class BlackPanther_stg implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "BlackPanther_stg.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(BlackPanther_stg.class);
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (BlackPanther_File != null) {

				this.setProperty("BlackPanther_File", BlackPanther_File.toString());

			}

			if (BlackPanther_Encoding != null) {

				this.setProperty("BlackPanther_Encoding", BlackPanther_Encoding.toString());

			}

			if (BlackPanther_RowSeparator != null) {

				this.setProperty("BlackPanther_RowSeparator", BlackPanther_RowSeparator.toString());

			}

			if (BlackPanther_FieldSeparator != null) {

				this.setProperty("BlackPanther_FieldSeparator", BlackPanther_FieldSeparator.toString());

			}

			if (BlackPanther_Header != null) {

				this.setProperty("BlackPanther_Header", BlackPanther_Header.toString());
		...
		public String BlackPanther_File;

		public String getBlackPanther_File() {
			return this.BlackPanther_File;
		}

		public String BlackPanther_Encoding;

		public String getBlackPanther_Encoding() {
			return this.BlackPanther_Encoding;
		}

		public String BlackPanther_RowSeparator;

		public String getBlackPanther_RowSeparator() {
			return this.BlackPanther_RowSeparator;
		}

		public String BlackPanther_FieldSeparator;

		public String getBlackPanther_FieldSeparator() {
			return this.BlackPanther_FieldSeparator;
		}

		public Integer BlackPanther_Header;

		public Integer getBlackPanther_Header() {
			return this.BlackPanther_Header;
		}
	...
	private final String jobName = "BlackPanther_stg";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					BlackPanther_stg.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(BlackPanther_stg.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class mysqlStruct implements routines.system.IPersistableRow<mysqlStruct> {
		final static byte[] commonByteArrayLock_GROUP14FINAL_BlackPanther_stg = new byte[0];
		static byte[] commonByteArray_GROUP14FINAL_BlackPanther_stg = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_GROUP14FINAL_BlackPanther_stg.length) {
					if (length < 1024 && commonByteArray_GROUP14FINAL_BlackPanther_stg.length == 0) {
						commonByteArray_GROUP14FINAL_BlackPanther_stg = new byte[1024];
					} else {
						commonByteArray_GROUP14FINAL_BlackPanther_stg = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_GROUP14FINAL_BlackPanther_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_BlackPanther_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_GROUP14FINAL_BlackPanther_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_BlackPanther_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_GROUP14FINAL_BlackPanther_stg) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "Cflhcy_" + subJobPidCounter.getAndIncrement());
...
// ###############################
					...
					class BytesLimit65535_tFileInputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_1
									.append("FILENAME" + " = " + "context.BlackPanther_File");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1.append("CSV_OPTION" + " = " + "false");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("ROWSEPARATOR" + " = " + "context.BlackPanther_RowSeparator");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("FIELDSEPARATOR" + " = " + "context.BlackPanther_FieldSeparator");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("HEADER" + " = " + "context.BlackPanther_Header");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							...
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("ENCODING" + " = " + "context.BlackPanther_Encoding");
							log4jParamters_tFileInputDelimited_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tFileInputDelimited_1", "BlackPanther", "tFileInputDelimited");
					talendJobLogProcess(globalMap);
				}
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = context.BlackPanther_File;
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.BlackPanther_File, context.BlackPanther_Encoding,
								context.BlackPanther_FieldSeparator, context.BlackPanther_RowSeparator, false,
								context.BlackPanther_Header, 0, limit_tFileInputDelimited_1, -1, false);
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "row1", "tFileInputDelimited_1", "BlackPanther", "tFileInputDelimited", "tMap_1",
									"tMap_1", "tMap"
...
// Start of branch "mysql"
					...
					if (!((Object) (context.BlackPanther_File) instanceof java.io.InputStream)) {
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tFileInputDelimited_1", "BlackPanther", "tFileInputDelimited", "tMap_1", "tMap_1", "tMap",
						"output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "P3WB9m_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final BlackPanther_stg BlackPanther_stgClass = new BlackPanther_stg();

		int exitCode = BlackPanther_stgClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'BlackPanther_stg' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'BlackPanther_stg' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_SnIN4JAMEe6a__awYeGrfA");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-03T02:12:16.613859900Z");
		...
		try {
			...
			java.io.InputStream inContext = BlackPanther_stg.class.getClassLoader()
					.getResourceAsStream("group14final/blackpanther_stg_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = BlackPanther_stg.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					context.setContextType("BlackPanther_File", "id_File");
					if (context.getStringValue("BlackPanther_File") == null) {
						context.BlackPanther_File = null;
					} else {
						context.BlackPanther_File = (String) context.getProperty("BlackPanther_File");
					}
					context.setContextType("BlackPanther_Encoding", "id_String");
					if (context.getStringValue("BlackPanther_Encoding") == null) {
						context.BlackPanther_Encoding = null;
					} else {
						context.BlackPanther_Encoding = (String) context.getProperty("BlackPanther_Encoding");
					}
					context.setContextType("BlackPanther_RowSeparator", "id_String");
					if (context.getStringValue("BlackPanther_RowSeparator") == null) {
						context.BlackPanther_RowSeparator = null;
					} else {
						context.BlackPanther_RowSeparator = (String) context.getProperty("BlackPanther_RowSeparator");
					}
					context.setContextType("BlackPanther_FieldSeparator", "id_String");
					if (context.getStringValue("BlackPanther_FieldSeparator") == null) {
						context.BlackPanther_FieldSeparator = null;
					} else {
						context.BlackPanther_FieldSeparator = (String) context
								.getProperty("BlackPanther_FieldSeparator");
					}
					context.setContextType("BlackPanther_Header", "id_Integer");
					if (context.getStringValue("BlackPanther_Header") == null) {
						context.BlackPanther_Header = null;
					} else {
						try {
							context.BlackPanther_Header = routines.system.ParserUtils
									.parseTo_Integer(context.getProperty("BlackPanther_Header"));
						} catch (NumberFormatException e) {
							log.warn(String.format("Null value will be used for context parameter %s: %s",
									"BlackPanther_Header", e.getMessage()));
							context.BlackPanther_Header = null;
						}
					}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("BlackPanther_File")) {
				context.BlackPanther_File = (String) parentContextMap.get("BlackPanther_File");
			}
			if (parentContextMap.containsKey("BlackPanther_Encoding")) {
				context.BlackPanther_Encoding = (String) parentContextMap.get("BlackPanther_Encoding");
			}
			if (parentContextMap.containsKey("BlackPanther_RowSeparator")) {
				context.BlackPanther_RowSeparator = (String) parentContextMap.get("BlackPanther_RowSeparator");
			}
			if (parentContextMap.containsKey("BlackPanther_FieldSeparator")) {
				context.BlackPanther_FieldSeparator = (String) parentContextMap.get("BlackPanther_FieldSeparator");
			}
			if (parentContextMap.containsKey("BlackPanther_Header")) {
				context.BlackPanther_Header = (Integer) parentContextMap.get("BlackPanther_Header");
			}
		...
		log.info("TalendJob: 'BlackPanther_stg' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : BlackPanther_stg");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'BlackPanther_stg' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 130033 characters generated by Talend Cloud Data Fabric on the December 2,
 * 2023 at 9:12:16 PM EST
 ************************************************************************************************/