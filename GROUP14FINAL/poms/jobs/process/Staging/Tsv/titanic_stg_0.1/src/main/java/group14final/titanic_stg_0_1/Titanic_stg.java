...
package group14final.titanic_stg_0_1;
 ...
 * @status
 */
public class Titanic_stg implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Titanic_stg.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(Titanic_stg.class);
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (Titanic_File != null) {

				this.setProperty("Titanic_File", Titanic_File.toString());

			}

			if (Titanic_Encoding != null) {

				this.setProperty("Titanic_Encoding", Titanic_Encoding.toString());

			}

			if (Titanic_RowSeparator != null) {

				this.setProperty("Titanic_RowSeparator", Titanic_RowSeparator.toString());

			}

			if (Titanic_FieldSeparator != null) {

				this.setProperty("Titanic_FieldSeparator", Titanic_FieldSeparator.toString());

			}

			if (Titanic_Header != null) {

				this.setProperty("Titanic_Header", Titanic_Header.toString());
		...
		public String Titanic_File;

		public String getTitanic_File() {
			return this.Titanic_File;
		}

		public String Titanic_Encoding;

		public String getTitanic_Encoding() {
			return this.Titanic_Encoding;
		}

		public String Titanic_RowSeparator;

		public String getTitanic_RowSeparator() {
			return this.Titanic_RowSeparator;
		}

		public String Titanic_FieldSeparator;

		public String getTitanic_FieldSeparator() {
			return this.Titanic_FieldSeparator;
		}

		public Integer Titanic_Header;

		public Integer getTitanic_Header() {
			return this.Titanic_Header;
		}
	...
	private final String jobName = "Titanic_stg";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Titanic_stg.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class mysqlStruct implements routines.system.IPersistableRow<mysqlStruct> {
		final static byte[] commonByteArrayLock_GROUP14FINAL_Titanic_stg = new byte[0];
		static byte[] commonByteArray_GROUP14FINAL_Titanic_stg = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_GROUP14FINAL_Titanic_stg.length) {
					if (length < 1024 && commonByteArray_GROUP14FINAL_Titanic_stg.length == 0) {
						commonByteArray_GROUP14FINAL_Titanic_stg = new byte[1024];
					} else {
						commonByteArray_GROUP14FINAL_Titanic_stg = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_GROUP14FINAL_Titanic_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_Titanic_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_GROUP14FINAL_Titanic_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_Titanic_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_GROUP14FINAL_Titanic_stg) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "okytzk_" + subJobPidCounter.getAndIncrement());
...
// ###############################
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tFileInputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = " + "context.Titanic_File");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1.append("CSV_OPTION" + " = " + "false");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("ROWSEPARATOR" + " = " + "context.Titanic_RowSeparator");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("FIELDSEPARATOR" + " = " + "context.Titanic_FieldSeparator");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1.append("HEADER" + " = " + "context.Titanic_Header");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							...
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("ENCODING" + " = " + "context.Titanic_Encoding");
							log4jParamters_tFileInputDelimited_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tFileInputDelimited_1", "Titanic", "tFileInputDelimited");
					talendJobLogProcess(globalMap);
				}
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = context.Titanic_File;
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(context.Titanic_File,
								context.Titanic_Encoding, context.Titanic_FieldSeparator, context.Titanic_RowSeparator,
								false, context.Titanic_Header, 0, limit_tFileInputDelimited_1, -1, false);
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "row1", "tFileInputDelimited_1", "Titanic", "tFileInputDelimited", "tMap_1",
									"tMap_1", "tMap"
...
// Start of branch "mysql"
							if (mysql != null) {
								...
								if (mysql.Days == null) {
									...
									pstmt_tDBOutput_1.setString(11, mysql.Days);
								}
					...
					if (!((Object) (context.Titanic_File) instanceof java.io.InputStream)) {
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tFileInputDelimited_1", "Titanic", "tFileInputDelimited", "tMap_1", "tMap_1", "tMap",
						"output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "eA6ylx_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final Titanic_stg Titanic_stgClass = new Titanic_stg();

		int exitCode = Titanic_stgClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Titanic_stg' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'Titanic_stg' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_fyn-0JAMEe6a__awYeGrfA");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-03T02:13:00.174549Z");
		...
		try {
			...
			java.io.InputStream inContext = Titanic_stg.class.getClassLoader()
					.getResourceAsStream("group14final/titanic_stg_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Titanic_stg.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					context.setContextType("Titanic_File", "id_File");
					if (context.getStringValue("Titanic_File") == null) {
						context.Titanic_File = null;
					} else {
						context.Titanic_File = (String) context.getProperty("Titanic_File");
					}
					context.setContextType("Titanic_Encoding", "id_String");
					if (context.getStringValue("Titanic_Encoding") == null) {
						context.Titanic_Encoding = null;
					} else {
						context.Titanic_Encoding = (String) context.getProperty("Titanic_Encoding");
					}
					context.setContextType("Titanic_RowSeparator", "id_String");
					if (context.getStringValue("Titanic_RowSeparator") == null) {
						context.Titanic_RowSeparator = null;
					} else {
						context.Titanic_RowSeparator = (String) context.getProperty("Titanic_RowSeparator");
					}
					context.setContextType("Titanic_FieldSeparator", "id_String");
					if (context.getStringValue("Titanic_FieldSeparator") == null) {
						context.Titanic_FieldSeparator = null;
					} else {
						context.Titanic_FieldSeparator = (String) context.getProperty("Titanic_FieldSeparator");
					}
					context.setContextType("Titanic_Header", "id_Integer");
					if (context.getStringValue("Titanic_Header") == null) {
						context.Titanic_Header = null;
					} else {
						try {
							context.Titanic_Header = routines.system.ParserUtils
									.parseTo_Integer(context.getProperty("Titanic_Header"));
						} catch (NumberFormatException e) {
							log.warn(String.format("Null value will be used for context parameter %s: %s",
									"Titanic_Header", e.getMessage()));
							context.Titanic_Header = null;
						}
					}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("Titanic_File")) {
				context.Titanic_File = (String) parentContextMap.get("Titanic_File");
			}
			if (parentContextMap.containsKey("Titanic_Encoding")) {
				context.Titanic_Encoding = (String) parentContextMap.get("Titanic_Encoding");
			}
			if (parentContextMap.containsKey("Titanic_RowSeparator")) {
				context.Titanic_RowSeparator = (String) parentContextMap.get("Titanic_RowSeparator");
			}
			if (parentContextMap.containsKey("Titanic_FieldSeparator")) {
				context.Titanic_FieldSeparator = (String) parentContextMap.get("Titanic_FieldSeparator");
			}
			if (parentContextMap.containsKey("Titanic_Header")) {
				context.Titanic_Header = (Integer) parentContextMap.get("Titanic_Header");
			}
		...
		log.info("TalendJob: 'Titanic_stg' - Started.");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Titanic_stg");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'Titanic_stg' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 126476 characters generated by Talend Cloud Data Fabric on the December 2,
 * 2023 at 9:13:00 PM EST
 ************************************************************************************************/