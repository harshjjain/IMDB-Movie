...
package group14final.avenger_aou_stg_0_1;
...
/**
 * Job: Avenger_AOU_stg Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Avenger_AOU_stg implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Avenger_AOU_stg.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(Avenger_AOU_stg.class);
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (Avengers_AOU_File != null) {

				this.setProperty("Avengers_AOU_File", Avengers_AOU_File.toString());

			}

			if (Avengers_AOU_Encoding != null) {

				this.setProperty("Avengers_AOU_Encoding", Avengers_AOU_Encoding.toString());

			}

			if (Avengers_AOU_RowSeparator != null) {

				this.setProperty("Avengers_AOU_RowSeparator", Avengers_AOU_RowSeparator.toString());

			}

			if (Avengers_AOU_FieldSeparator != null) {

				this.setProperty("Avengers_AOU_FieldSeparator", Avengers_AOU_FieldSeparator.toString());

			}

			if (Avengers_AOU_Header != null) {

				this.setProperty("Avengers_AOU_Header", Avengers_AOU_Header.toString());
		...
		public String Avengers_AOU_File;

		public String getAvengers_AOU_File() {
			return this.Avengers_AOU_File;
		}

		public String Avengers_AOU_Encoding;

		public String getAvengers_AOU_Encoding() {
			return this.Avengers_AOU_Encoding;
		}

		public String Avengers_AOU_RowSeparator;

		public String getAvengers_AOU_RowSeparator() {
			return this.Avengers_AOU_RowSeparator;
		}

		public String Avengers_AOU_FieldSeparator;

		public String getAvengers_AOU_FieldSeparator() {
			return this.Avengers_AOU_FieldSeparator;
		}

		public Integer Avengers_AOU_Header;

		public Integer getAvengers_AOU_Header() {
			return this.Avengers_AOU_Header;
		}
	...
	private final String jobName = "Avenger_AOU_stg";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Avenger_AOU_stg.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Avenger_AOU_stg.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class mysqlStruct implements routines.system.IPersistableRow<mysqlStruct> {
		final static byte[] commonByteArrayLock_GROUP14FINAL_Avenger_AOU_stg = new byte[0];
		static byte[] commonByteArray_GROUP14FINAL_Avenger_AOU_stg = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_GROUP14FINAL_Avenger_AOU_stg.length) {
					if (length < 1024 && commonByteArray_GROUP14FINAL_Avenger_AOU_stg.length == 0) {
						commonByteArray_GROUP14FINAL_Avenger_AOU_stg = new byte[1024];
					} else {
						commonByteArray_GROUP14FINAL_Avenger_AOU_stg = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_GROUP14FINAL_Avenger_AOU_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_Avenger_AOU_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_GROUP14FINAL_Avenger_AOU_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_Avenger_AOU_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_GROUP14FINAL_Avenger_AOU_stg) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "FCbiis_" + subJobPidCounter.getAndIncrement());
...
// ###############################
					...
					class BytesLimit65535_tFileInputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_1
									.append("FILENAME" + " = " + "context.Avengers_AOU_File");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1.append("CSV_OPTION" + " = " + "false");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("ROWSEPARATOR" + " = " + "context.Avengers_AOU_RowSeparator");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("FIELDSEPARATOR" + " = " + "context.Avengers_AOU_FieldSeparator");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("HEADER" + " = " + "context.Avengers_AOU_Header");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							...
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("ENCODING" + " = " + "context.Avengers_AOU_Encoding");
							log4jParamters_tFileInputDelimited_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tFileInputDelimited_1", "Avengers_AOU", "tFileInputDelimited");
					talendJobLogProcess(globalMap);
				}
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = context.Avengers_AOU_File;
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.Avengers_AOU_File, context.Avengers_AOU_Encoding,
								context.Avengers_AOU_FieldSeparator, context.Avengers_AOU_RowSeparator, false,
								context.Avengers_AOU_Header, 0, limit_tFileInputDelimited_1, -1, false);
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "row1", "tFileInputDelimited_1", "Avengers_AOU", "tFileInputDelimited", "tMap_1",
									"tMap_1", "tMap"
...
// Start of branch "mysql"
					...
					if (!((Object) (context.Avengers_AOU_File) instanceof java.io.InputStream)) {
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tFileInputDelimited_1", "Avengers_AOU", "tFileInputDelimited", "tMap_1", "tMap_1", "tMap",
						"output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "0W3crF_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final Avenger_AOU_stg Avenger_AOU_stgClass = new Avenger_AOU_stg();

		int exitCode = Avenger_AOU_stgClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Avenger_AOU_stg' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'Avenger_AOU_stg' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_r9umkJAIEe6a__awYeGrfA");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-03T02:11:44.261575600Z");
		...
		try {
			...
			java.io.InputStream inContext = Avenger_AOU_stg.class.getClassLoader()
					.getResourceAsStream("group14final/avenger_aou_stg_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Avenger_AOU_stg.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					context.setContextType("Avengers_AOU_File", "id_File");
					if (context.getStringValue("Avengers_AOU_File") == null) {
						context.Avengers_AOU_File = null;
					} else {
						context.Avengers_AOU_File = (String) context.getProperty("Avengers_AOU_File");
					}
					context.setContextType("Avengers_AOU_Encoding", "id_String");
					if (context.getStringValue("Avengers_AOU_Encoding") == null) {
						context.Avengers_AOU_Encoding = null;
					} else {
						context.Avengers_AOU_Encoding = (String) context.getProperty("Avengers_AOU_Encoding");
					}
					context.setContextType("Avengers_AOU_RowSeparator", "id_String");
					if (context.getStringValue("Avengers_AOU_RowSeparator") == null) {
						context.Avengers_AOU_RowSeparator = null;
					} else {
						context.Avengers_AOU_RowSeparator = (String) context.getProperty("Avengers_AOU_RowSeparator");
					}
					context.setContextType("Avengers_AOU_FieldSeparator", "id_String");
					if (context.getStringValue("Avengers_AOU_FieldSeparator") == null) {
						context.Avengers_AOU_FieldSeparator = null;
					} else {
						context.Avengers_AOU_FieldSeparator = (String) context
								.getProperty("Avengers_AOU_FieldSeparator");
					}
					context.setContextType("Avengers_AOU_Header", "id_Integer");
					if (context.getStringValue("Avengers_AOU_Header") == null) {
						context.Avengers_AOU_Header = null;
					} else {
						try {
							context.Avengers_AOU_Header = routines.system.ParserUtils
									.parseTo_Integer(context.getProperty("Avengers_AOU_Header"));
						} catch (NumberFormatException e) {
							log.warn(String.format("Null value will be used for context parameter %s: %s",
									"Avengers_AOU_Header", e.getMessage()));
							context.Avengers_AOU_Header = null;
						}
					}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("Avengers_AOU_File")) {
				context.Avengers_AOU_File = (String) parentContextMap.get("Avengers_AOU_File");
			}
			if (parentContextMap.containsKey("Avengers_AOU_Encoding")) {
				context.Avengers_AOU_Encoding = (String) parentContextMap.get("Avengers_AOU_Encoding");
			}
			if (parentContextMap.containsKey("Avengers_AOU_RowSeparator")) {
				context.Avengers_AOU_RowSeparator = (String) parentContextMap.get("Avengers_AOU_RowSeparator");
			}
			if (parentContextMap.containsKey("Avengers_AOU_FieldSeparator")) {
				context.Avengers_AOU_FieldSeparator = (String) parentContextMap.get("Avengers_AOU_FieldSeparator");
			}
			if (parentContextMap.containsKey("Avengers_AOU_Header")) {
				context.Avengers_AOU_Header = (Integer) parentContextMap.get("Avengers_AOU_Header");
			}
		...
		log.info("TalendJob: 'Avenger_AOU_stg' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Avenger_AOU_stg");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'Avenger_AOU_stg' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 129979 characters generated by Talend Cloud Data Fabric on the December 2,
 * 2023 at 9:11:44 PM EST
 ************************************************************************************************/