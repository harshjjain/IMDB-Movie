...
package group14final.avatar_stg_0_1;
 ...
 * @status
 */
public class Avatar_Stg implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Avatar_Stg.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(Avatar_Stg.class);
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (Avatar_File != null) {
				...
				this.setProperty("Avatar_File", Avatar_File.toString());

			}

			if (Avatar_Encoding != null) {

				this.setProperty("Avatar_Encoding", Avatar_Encoding.toString());

			}

			if (Avatar_RowSeparator != null) {

				this.setProperty("Avatar_RowSeparator", Avatar_RowSeparator.toString());

			}

			if (Avatar_FieldSeparator != null) {

				this.setProperty("Avatar_FieldSeparator", Avatar_FieldSeparator.toString());

			}

			if (Avatar_Header != null) {

				this.setProperty("Avatar_Header", Avatar_Header.toString());
		...
		public String Avatar_Encoding;

		public String getAvatar_Encoding() {
			return this.Avatar_Encoding;
		}

		public String Avatar_RowSeparator;

		public String getAvatar_RowSeparator() {
			return this.Avatar_RowSeparator;
		}

		public String Avatar_FieldSeparator;

		public String getAvatar_FieldSeparator() {
			return this.Avatar_FieldSeparator;
		}

		public Integer Avatar_Header;

		public Integer getAvatar_Header() {
			return this.Avatar_Header;
		}
	...
	private final String jobName = "Avatar_Stg";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Avatar_Stg.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class mysqlStruct implements routines.system.IPersistableRow<mysqlStruct> {
		final static byte[] commonByteArrayLock_GROUP14FINAL_Avatar_Stg = new byte[0];
		static byte[] commonByteArray_GROUP14FINAL_Avatar_Stg = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_GROUP14FINAL_Avatar_Stg.length) {
					if (length < 1024 && commonByteArray_GROUP14FINAL_Avatar_Stg.length == 0) {
						commonByteArray_GROUP14FINAL_Avatar_Stg = new byte[1024];
					} else {
						commonByteArray_GROUP14FINAL_Avatar_Stg = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_GROUP14FINAL_Avatar_Stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_Avatar_Stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_GROUP14FINAL_Avatar_Stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_Avatar_Stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_GROUP14FINAL_Avatar_Stg) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "6b7Heo_" + subJobPidCounter.getAndIncrement());
...
// ###############################
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tFileInputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = " + "context.Avatar_File");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1.append("CSV_OPTION" + " = " + "false");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("ROWSEPARATOR" + " = " + "context.Avatar_RowSeparator");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1
									.append("FIELDSEPARATOR" + " = " + "context.Avatar_FieldSeparator");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1.append("HEADER" + " = " + "context.Avatar_Header");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							...
							log4jParamters_tFileInputDelimited_1.append(" | ");
							log4jParamters_tFileInputDelimited_1.append("ENCODING" + " = " + "context.Avatar_Encoding");
							log4jParamters_tFileInputDelimited_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tFileInputDelimited_1", "Avatar", "tFileInputDelimited");
					talendJobLogProcess(globalMap);
				}
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = context.Avatar_File;
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(context.Avatar_File,
								context.Avatar_Encoding, context.Avatar_FieldSeparator, context.Avatar_RowSeparator,
								false, context.Avatar_Header, 0, limit_tFileInputDelimited_1, -1, false);
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.Days = ParserUtils.parseTo_int(temp);
								...
								rowstate_tFileInputDelimited_1.setException(new RuntimeException(
										"Value is empty for column : 'Days' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "row1", "tFileInputDelimited_1", "Avatar", "tFileInputDelimited", "tMap_1",
									"tMap_1", "tMap"
...
// Start of branch "mysql"
					...
					if (!((Object) (context.Avatar_File) instanceof java.io.InputStream)) {
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tFileInputDelimited_1", "Avatar", "tFileInputDelimited", "tMap_1", "tMap_1", "tMap",
						"output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "eZCi8N_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final Avatar_Stg Avatar_StgClass = new Avatar_Stg();

		int exitCode = Avatar_StgClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Avatar_Stg' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'Avatar_Stg' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_IB8fQJAJEe6a__awYeGrfA");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-03T02:11:33.912861700Z");
		...
		try {
			...
			java.io.InputStream inContext = Avatar_Stg.class.getClassLoader()
					.getResourceAsStream("group14final/avatar_stg_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Avatar_Stg.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					context.setContextType("Avatar_File", "id_File");
					if (context.getStringValue("Avatar_File") == null) {
						context.Avatar_File = null;
					} else {
						context.Avatar_File = (String) context.getProperty("Avatar_File");
					}
					context.setContextType("Avatar_Encoding", "id_String");
					if (context.getStringValue("Avatar_Encoding") == null) {
						context.Avatar_Encoding = null;
					} else {
						context.Avatar_Encoding = (String) context.getProperty("Avatar_Encoding");
					}
					context.setContextType("Avatar_RowSeparator", "id_String");
					if (context.getStringValue("Avatar_RowSeparator") == null) {
						context.Avatar_RowSeparator = null;
					} else {
						context.Avatar_RowSeparator = (String) context.getProperty("Avatar_RowSeparator");
					}
					context.setContextType("Avatar_FieldSeparator", "id_String");
					if (context.getStringValue("Avatar_FieldSeparator") == null) {
						context.Avatar_FieldSeparator = null;
					} else {
						context.Avatar_FieldSeparator = (String) context.getProperty("Avatar_FieldSeparator");
					}
					context.setContextType("Avatar_Header", "id_Integer");
					if (context.getStringValue("Avatar_Header") == null) {
						context.Avatar_Header = null;
					} else {
						try {
							context.Avatar_Header = routines.system.ParserUtils
									.parseTo_Integer(context.getProperty("Avatar_Header"));
						} catch (NumberFormatException e) {
							log.warn(String.format("Null value will be used for context parameter %s: %s",
									"Avatar_Header", e.getMessage()));
							context.Avatar_Header = null;
						}
					}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("Avatar_File")) {
				context.Avatar_File = (String) parentContextMap.get("Avatar_File");
			}
			if (parentContextMap.containsKey("Avatar_Encoding")) {
				context.Avatar_Encoding = (String) parentContextMap.get("Avatar_Encoding");
			}
			if (parentContextMap.containsKey("Avatar_RowSeparator")) {
				context.Avatar_RowSeparator = (String) parentContextMap.get("Avatar_RowSeparator");
			}
			if (parentContextMap.containsKey("Avatar_FieldSeparator")) {
				context.Avatar_FieldSeparator = (String) parentContextMap.get("Avatar_FieldSeparator");
			}
			if (parentContextMap.containsKey("Avatar_Header")) {
				context.Avatar_Header = (Integer) parentContextMap.get("Avatar_Header");
			}
		...
		log.info("TalendJob: 'Avatar_Stg' - Started.");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Avatar_Stg");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'Avatar_Stg' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 126940 characters generated by Talend Cloud Data Fabric on the December 2,
 * 2023 at 9:11:33 PM EST
 ************************************************************************************************/