...
package group14final.imdb_title_basics_stg_0_1;
...
/**
 * Job: imdb_title_basics_stg Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class imdb_title_basics_stg implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "imdb_title_basics_stg.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(imdb_title_basics_stg.class);
	...
	private final String jobName = "imdb_title_basics_stg";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					imdb_title_basics_stg.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(imdb_title_basics_stg.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class mysqlStruct implements routines.system.IPersistableRow<mysqlStruct> {
		final static byte[] commonByteArrayLock_GROUP14FINAL_imdb_title_basics_stg = new byte[0];
		static byte[] commonByteArray_GROUP14FINAL_imdb_title_basics_stg = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_GROUP14FINAL_imdb_title_basics_stg.length) {
					if (length < 1024 && commonByteArray_GROUP14FINAL_imdb_title_basics_stg.length == 0) {
						commonByteArray_GROUP14FINAL_imdb_title_basics_stg = new byte[1024];
					} else {
						commonByteArray_GROUP14FINAL_imdb_title_basics_stg = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_GROUP14FINAL_imdb_title_basics_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_imdb_title_basics_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_GROUP14FINAL_imdb_title_basics_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_imdb_title_basics_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_GROUP14FINAL_imdb_title_basics_stg) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "F91P2q_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBOutput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_1.append("PASS" + " = "
									...
									+ "...");
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"imdb_title_basics_stg\"");
							log4jParamters_tDBOutput_1.append(" | ");
				...
				String tableName_tDBOutput_1 = "imdb_title_basics_stg";
				...
				while (rsTable_tDBOutput_1.next()) {
					...
					if (table_tDBOutput_1.equalsIgnoreCase("imdb_title_basics_stg")) {
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						...
						stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
								+ "`(`tconst` VARCHAR(10)   not null ,`titleType` VARCHAR(255)  ,`primaryTitle` VARCHAR(1024)  ,`originalTitle` VARCHAR(1024)  ,`isAdult` TINYINT(3)  ,`startYear` VARCHAR(4)  ,`endYear` VARCHAR(4)  ,`runtimeMinutes` VARCHAR(10)  ,`genres` VARCHAR(255)  ,`DI_Create_DT` DATETIME default CURRENT_TIMESTAMP  not null ,primary key(`tconst`))");
						if (log.isDebugEnabled())
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "imdb_title_basics_stg"
						+ "` (`tconst`,`titleType`,`primaryTitle`,`originalTitle`,`isAdult`,`startYear`,`endYear`,`runtimeMinutes`,`genres`,`DI_Create_DT`) VALUES (?,?,?,?,?,?,?,?,?,?)";
...
// ###############################
						...
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1
									.append("PASS" + " = "
											...
											+ "...");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"imdb_title_basics\"");
							log4jParamters_tDBInput_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBInput_1", "\"imdb_title_basics\"", "tMysqlInput");
					talendJobLogProcess(globalMap);
				}
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row1", "tDBInput_1", "\"imdb_title_basics\"", "tMysqlInput", "tMap_1", "tMap_1",
								"tMap"
...
// # Output table : 'mysql'
							...
							mysql_tmp.titleType = row1.titleType;
							mysql_tmp.primaryTitle = row1.primaryTitle;
							mysql_tmp.originalTitle = row1.originalTitle;
							mysql_tmp.isAdult = row1.isAdult;
							mysql_tmp.startYear = row1.startYear;
							mysql_tmp.endYear = row1.endYear;
							mysql_tmp.runtimeMinutes = row1.runtimeMinutes;
							mysql_tmp.genres = row1.genres;
...
// Start of branch "mysql"
						if (mysql != null) {
							...
							if (mysql.titleType == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(2, mysql.titleType);
							}

							if (mysql.primaryTitle == null) {
								pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(3, mysql.primaryTitle);
							}

							if (mysql.originalTitle == null) {
								pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(4, mysql.originalTitle);
							}

							if (mysql.isAdult == null) {
								pstmt_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setByte(5, mysql.isAdult);
							}

							if (mysql.startYear == null) {
								pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(6, mysql.startYear);
							}

							if (mysql.endYear == null) {
								pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(7, mysql.endYear);
							}

							if (mysql.runtimeMinutes == null) {
								pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(8, mysql.runtimeMinutes);
							}

							if (mysql.genres == null) {
								pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(9, mysql.genres);
							}
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tDBInput_1", "\"imdb_title_basics\"", "tMysqlInput", "tMap_1", "tMap_1", "tMap", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "O76E6i_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final imdb_title_basics_stg imdb_title_basics_stgClass = new imdb_title_basics_stg();

		int exitCode = imdb_title_basics_stgClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'imdb_title_basics_stg' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'imdb_title_basics_stg' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_recTEI_HEe62yM1cY-rR4Q");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-11-30T22:36:09.427912900Z");
		...
		try {
			...
			java.io.InputStream inContext = imdb_title_basics_stg.class.getClassLoader().getResourceAsStream(
					"group14final/imdb_title_basics_stg_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = imdb_title_basics_stg.class.getClassLoader()
		...
		log.info("TalendJob: 'imdb_title_basics_stg' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : imdb_title_basics_stg");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'imdb_title_basics_stg' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 135340 characters generated by Talend Cloud Data Fabric on the November 30,
 * 2023 at 5:36:09 PM EST
 ************************************************************************************************/