...
package group14final.imdb_title_ratings_stg_0_1;
...
/**
 * Job: imdb_title_ratings_stg Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class imdb_title_ratings_stg implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "imdb_title_ratings_stg.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(imdb_title_ratings_stg.class);
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (imdb_src_Server != null) {

				this.setProperty("imdb_src_Server", imdb_src_Server.toString());

			}

			if (imdb_src_Login != null) {

				this.setProperty("imdb_src_Login", imdb_src_Login.toString());

			}

			if (imdb_src_Database != null) {

				this.setProperty("imdb_src_Database", imdb_src_Database.toString());

			}

			if (imdb_src_Password != null) {

				this.setProperty("imdb_src_Password", imdb_src_Password.toString());

			}

			if (imdb_src_Port != null) {

				this.setProperty("imdb_src_Port", imdb_src_Port.toString());

			}

			if (imdb_src_AdditionalParams != null) {

				this.setProperty("imdb_src_AdditionalParams", imdb_src_AdditionalParams.toString());
		...
		public String imdb_src_Server;

		public String getImdb_src_Server() {
			return this.imdb_src_Server;
		}

		public String imdb_src_Login;

		public String getImdb_src_Login() {
			return this.imdb_src_Login;
		}

		public String imdb_src_Database;

		public String getImdb_src_Database() {
			return this.imdb_src_Database;
		}

		public java.lang.String imdb_src_Password;

		public java.lang.String getImdb_src_Password() {
			return this.imdb_src_Password;
		}

		public String imdb_src_Port;

		public String getImdb_src_Port() {
			return this.imdb_src_Port;
		}

		public String imdb_src_AdditionalParams;

		public String getImdb_src_AdditionalParams() {
			return this.imdb_src_AdditionalParams;
		}
	...
	private final String jobName = "imdb_title_ratings_stg";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					imdb_title_ratings_stg.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(imdb_title_ratings_stg.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class mysqlStruct implements routines.system.IPersistableRow<mysqlStruct> {
		final static byte[] commonByteArrayLock_GROUP14FINAL_imdb_title_ratings_stg = new byte[0];
		static byte[] commonByteArray_GROUP14FINAL_imdb_title_ratings_stg = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final mysqlStruct other = (mysqlStruct) obj;
		...
		public void copyDataTo(mysqlStruct other) {

			other.tconst = this.tconst;
			other.averageRating = this.averageRating;
			other.numVotes = this.numVotes;
			other.DI_Create_DT = this.DI_Create_DT;

		}

		public void copyKeysDataTo(mysqlStruct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_GROUP14FINAL_imdb_title_ratings_stg.length) {
					if (length < 1024 && commonByteArray_GROUP14FINAL_imdb_title_ratings_stg.length == 0) {
						commonByteArray_GROUP14FINAL_imdb_title_ratings_stg = new byte[1024];
					} else {
						commonByteArray_GROUP14FINAL_imdb_title_ratings_stg = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_GROUP14FINAL_imdb_title_ratings_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_imdb_title_ratings_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_GROUP14FINAL_imdb_title_ratings_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_imdb_title_ratings_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_GROUP14FINAL_imdb_title_ratings_stg) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "0WPWr5_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBOutput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_2.append(" | ");
							log4jParamters_tDBOutput_2.append("HOST" + " = " + "context.imdb_Server");
							log4jParamters_tDBOutput_2.append(" | ");
							log4jParamters_tDBOutput_2.append("PORT" + " = " + "context.imdb_Port");
							log4jParamters_tDBOutput_2.append(" | ");
							log4jParamters_tDBOutput_2.append("DBNAME" + " = " + "context.imdb_Database");
							log4jParamters_tDBOutput_2.append(" | ");
							log4jParamters_tDBOutput_2.append("USER" + " = " + "context.imdb_Login");
							log4jParamters_tDBOutput_2.append(" | ");
							log4jParamters_tDBOutput_2.append("PASS" + " = "
									...
									+ "...");
							log4jParamters_tDBOutput_2.append(" | ");
							log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"imdb_title_ratings_stg\"");
							log4jParamters_tDBOutput_2.append(" | ");
							...
							log4jParamters_tDBOutput_2.append(" | ");
							log4jParamters_tDBOutput_2.append("PROPERTIES" + " = " + "context.imdb_AdditionalParams");
							log4jParamters_tDBOutput_2.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBOutput_2", "imdb", "tMysqlOutput");
					talendJobLogProcess(globalMap);
				}
				...
				String tableName_tDBOutput_2 = "imdb_title_ratings_stg";
				...
				String properties_tDBOutput_2 = context.imdb_AdditionalParams;
				...
				String url_tDBOutput_2 = "jdbc:mysql://" + context.imdb_Server + ":" + context.imdb_Port + "/"
						+ context.imdb_Database + "?" + properties_tDBOutput_2;

				String driverClass_tDBOutput_2 = "com.mysql.cj.jdbc.Driver";

				if (log.isDebugEnabled())
					log.debug("tDBOutput_2 - " + ("Driver ClassName: ") + (driverClass_tDBOutput_2) + ("."));
				String dbUser_tDBOutput_2 = context.imdb_Login;

				final String decryptedPassword_tDBOutput_2 = context.imdb_Password;
				...
				java.sql.ResultSet rsTable_tDBOutput_2 = dbMetaData_tDBOutput_2.getTables(context.imdb_Database, null,
						null, new String[] { "TABLE" });
				boolean whetherExist_tDBOutput_2 = false;
				while (rsTable_tDBOutput_2.next()) {
					String table_tDBOutput_2 = rsTable_tDBOutput_2.getString("TABLE_NAME");
					if (table_tDBOutput_2.equalsIgnoreCase("imdb_title_ratings_stg")) {
				...
				if (!whetherExist_tDBOutput_2) {
					try (java.sql.Statement stmtCreate_tDBOutput_2 = conn_tDBOutput_2.createStatement()) {
						...
						stmtCreate_tDBOutput_2.execute("CREATE TABLE `" + tableName_tDBOutput_2
								+ "`(`tconst` VARCHAR(10)   not null ,`averageRating` DOUBLE(22,10)  ,`numVotes` INT(10)  ,`DI_Create_DT` DATETIME default CURRENT_TIMESTAMP  not null ,primary key(`tconst`))");
						if (log.isDebugEnabled())
				...
				String insert_tDBOutput_2 = "INSERT INTO `" + "imdb_title_ratings_stg"
						+ "` (`tconst`,`averageRating`,`numVotes`,`DI_Create_DT`) VALUES (?,?,?,?)";
...
// ###############################
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("HOST" + " = " + "context.imdb_src_Server");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("PORT" + " = " + "context.imdb_src_Port");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("DBNAME" + " = " + "context.imdb_src_Database");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("USER" + " = " + "context.imdb_src_Login");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1
									.append("PASS" + " = "
											+ String.valueOf(routines.system.PasswordEncryptUtil
													.encryptPassword(context.imdb_src_Password)).substring(0, 4)
											+ "...");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"imdb_title_ratings\"");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("QUERY" + " = "
									+ "\"SELECT    `imdb_title_ratings`.`tconst`,    `imdb_title_ratings`.`averageRating`,    `imdb_title_ratings`.`numVotes`,    `imdb_title_ratings`.`DI_Create_DT` FROM `imdb_title_ratings`\"");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("SPECIFY_DATASOURCE_ALIAS" + " = " + "false");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1
									.append("PROPERTIES" + " = " + "context.imdb_src_AdditionalParams");
							log4jParamters_tDBInput_1.append(" | ");
							...
							log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM=" + ("false")
									...
									+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("DI_Create_DT") + "}]");
							log4jParamters_tDBInput_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBInput_1", "\"imdb_title_ratings\"", "tMysqlInput");
					talendJobLogProcess(globalMap);
				}
				...
				String dbUser_tDBInput_1 = context.imdb_src_Login;

				final String decryptedPassword_tDBInput_1 = context.imdb_src_Password;

				String dbPwd_tDBInput_1 = decryptedPassword_tDBInput_1;

				String properties_tDBInput_1 = context.imdb_src_AdditionalParams;
				if (properties_tDBInput_1 == null || properties_tDBInput_1.trim().length() == 0) {
					properties_tDBInput_1 = "";
				}
				String url_tDBInput_1 = "jdbc:mysql://" + context.imdb_src_Server + ":" + context.imdb_src_Port + "/"
						+ context.imdb_src_Database + "?" + properties_tDBInput_1;
				...
				String dbquery_tDBInput_1 = "SELECT \n  `imdb_title_ratings`.`tconst`, \n  `imdb_title_ratings`.`averageRating`, \n  `imdb_title_ratings`.`numVotes`, \n"
						+ "  `imdb_title_ratings`.`DI_Create_DT`\nFROM `imdb_title_ratings`";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							row1.averageRating = null;
						} else {

							row1.averageRating = rs_tDBInput_1.getDouble(2);
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							row1.numVotes = rs_tDBInput_1.getInt(3);
							if (rs_tDBInput_1.wasNull()) {
								row1.numVotes = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 4) {
							...
							if (rs_tDBInput_1.getString(4) != null) {
								...
								if (!("0000-00-00").equals(dateString_tDBInput_1)
									...
									row1.DI_Create_DT = rs_tDBInput_1.getTimestamp(4);
								} else {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row1", "tDBInput_1", "\"imdb_title_ratings\"", "tMysqlInput", "tMap_1", "tMap_1",
								"tMap"
...
// # Output table : 'mysql'
							...
							mysql_tmp.averageRating = row1.averageRating;
							mysql_tmp.numVotes = row1.numVotes;
							mysql_tmp.DI_Create_DT = row1.DI_Create_DT;
							mysql = mysql_tmp;
...
// Start of branch "mysql"
						if (mysql != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "mysql", "tMap_1", "tMap_1", "tMap", "tDBOutput_2", "imdb", "tMysqlOutput"
							...
							if (mysql.tconst == null) {
								...
								pstmt_tDBOutput_2.setString(1, mysql.tconst);
							}

							if (mysql.averageRating == null) {
								pstmt_tDBOutput_2.setNull(2, java.sql.Types.DOUBLE);
							} else {
								pstmt_tDBOutput_2.setDouble(2, mysql.averageRating);
							}

							if (mysql.numVotes == null) {
								pstmt_tDBOutput_2.setNull(3, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setInt(3, mysql.numVotes);
							}

							if (mysql.DI_Create_DT != null) {
								date_tDBOutput_2 = mysql.DI_Create_DT.getTime();
								if (date_tDBOutput_2 < year1_tDBOutput_2 || date_tDBOutput_2 >= year10000_tDBOutput_2) {
									...
									pstmt_tDBOutput_2.setTimestamp(4, new java.sql.Timestamp(date_tDBOutput_2));
								}
							} else {
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tDBInput_1", "\"imdb_title_ratings\"", "tMysqlInput", "tMap_1", "tMap_1", "tMap", "output")) {
					talendJobLogProcess(globalMap);
				}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "mysql", 2, 0, "tMap_1",
						"tMap_1", "tMap", "tDBOutput_2", "imdb", "tMysqlOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "z1EXyb_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final imdb_title_ratings_stg imdb_title_ratings_stgClass = new imdb_title_ratings_stg();

		int exitCode = imdb_title_ratings_stgClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'imdb_title_ratings_stg' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'imdb_title_ratings_stg' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_6bwm8I_HEe62yM1cY-rR4Q");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-03T18:54:35.392998800Z");
		...
		try {
			...
			java.io.InputStream inContext = imdb_title_ratings_stg.class.getClassLoader().getResourceAsStream(
					"group14final/imdb_title_ratings_stg_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = imdb_title_ratings_stg.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					context.setContextType("imdb_src_Server", "id_String");
					if (context.getStringValue("imdb_src_Server") == null) {
						context.imdb_src_Server = null;
					} else {
						context.imdb_src_Server = (String) context.getProperty("imdb_src_Server");
					}
					context.setContextType("imdb_src_Login", "id_String");
					if (context.getStringValue("imdb_src_Login") == null) {
						context.imdb_src_Login = null;
					} else {
						context.imdb_src_Login = (String) context.getProperty("imdb_src_Login");
					}
					context.setContextType("imdb_src_Database", "id_String");
					if (context.getStringValue("imdb_src_Database") == null) {
						context.imdb_src_Database = null;
					} else {
						context.imdb_src_Database = (String) context.getProperty("imdb_src_Database");
					}
					context.setContextType("imdb_src_Password", "id_Password");
					if (context.getStringValue("imdb_src_Password") == null) {
						context.imdb_src_Password = null;
					} else {
						String pwd_imdb_src_Password_value = context.getProperty("imdb_src_Password");
						context.imdb_src_Password = null;
						if (pwd_imdb_src_Password_value != null) {
							if (context_param.containsKey("imdb_src_Password")) {// no need to decrypt if it come from
																					// program argument or parent job
																					// runtime
								context.imdb_src_Password = pwd_imdb_src_Password_value;
							} else if (!pwd_imdb_src_Password_value.isEmpty()) {
								try {
									context.imdb_src_Password = routines.system.PasswordEncryptUtil
											.decryptPassword(pwd_imdb_src_Password_value);
									context.put("imdb_src_Password", context.imdb_src_Password);
					...
					context.setContextType("imdb_src_Port", "id_String");
					if (context.getStringValue("imdb_src_Port") == null) {
						context.imdb_src_Port = null;
					} else {
						context.imdb_src_Port = (String) context.getProperty("imdb_src_Port");
					}
					context.setContextType("imdb_src_AdditionalParams", "id_String");
					if (context.getStringValue("imdb_src_AdditionalParams") == null) {
						context.imdb_src_AdditionalParams = null;
					} else {
						context.imdb_src_AdditionalParams = (String) context.getProperty("imdb_src_AdditionalParams");
					}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("imdb_src_Server")) {
				context.imdb_src_Server = (String) parentContextMap.get("imdb_src_Server");
			}
			if (parentContextMap.containsKey("imdb_src_Login")) {
				context.imdb_src_Login = (String) parentContextMap.get("imdb_src_Login");
			}
			if (parentContextMap.containsKey("imdb_src_Database")) {
				context.imdb_src_Database = (String) parentContextMap.get("imdb_src_Database");
			}
			if (parentContextMap.containsKey("imdb_src_Password")) {
				context.imdb_src_Password = (java.lang.String) parentContextMap.get("imdb_src_Password");
			}
			if (parentContextMap.containsKey("imdb_src_Port")) {
				context.imdb_src_Port = (String) parentContextMap.get("imdb_src_Port");
			}
			if (parentContextMap.containsKey("imdb_src_AdditionalParams")) {
				context.imdb_src_AdditionalParams = (String) parentContextMap.get("imdb_src_AdditionalParams");
			}
		...
		parametersToEncrypt.add("imdb_src_Password");
		...
		log.info("TalendJob: 'imdb_title_ratings_stg' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : imdb_title_ratings_stg");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'imdb_title_ratings_stg' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 119265 characters generated by Talend Cloud Data Fabric on the December 3,
 * 2023 at 1:54:35 PM EST
 ************************************************************************************************/