...
package group14final.imdb_title_akas_stg_0_1;
...
/**
 * Job: imdb_title_akas_stg Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class imdb_title_akas_stg implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "imdb_title_akas_stg.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(imdb_title_akas_stg.class);
	...
	private final String jobName = "imdb_title_akas_stg";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					imdb_title_akas_stg.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(imdb_title_akas_stg.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class mysqlStruct implements routines.system.IPersistableRow<mysqlStruct> {
		final static byte[] commonByteArrayLock_GROUP14FINAL_imdb_title_akas_stg = new byte[0];
		static byte[] commonByteArray_GROUP14FINAL_imdb_title_akas_stg = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_GROUP14FINAL_imdb_title_akas_stg.length) {
					if (length < 1024 && commonByteArray_GROUP14FINAL_imdb_title_akas_stg.length == 0) {
						commonByteArray_GROUP14FINAL_imdb_title_akas_stg = new byte[1024];
					} else {
						commonByteArray_GROUP14FINAL_imdb_title_akas_stg = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_GROUP14FINAL_imdb_title_akas_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_imdb_title_akas_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_GROUP14FINAL_imdb_title_akas_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_imdb_title_akas_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_GROUP14FINAL_imdb_title_akas_stg) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "g5o86E_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBOutput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_1.append("PASS" + " = "
									...
									+ "...");
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"imdb_title_akas_stg\"");
							log4jParamters_tDBOutput_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBOutput_1", "imdb", "tMysqlOutput");
					talendJobLogProcess(globalMap);
				}
				...
				String tableName_tDBOutput_1 = "imdb_title_akas_stg";
				...
				java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(context.imdb_Database, null,
						null, new String[] { "TABLE" });
				boolean whetherExist_tDBOutput_1 = false;
				while (rsTable_tDBOutput_1.next()) {
					String table_tDBOutput_1 = rsTable_tDBOutput_1.getString("TABLE_NAME");
					if (table_tDBOutput_1.equalsIgnoreCase("imdb_title_akas_stg")) {
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						...
						stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
								+ "`(`titleId` VARCHAR(10)   not null ,`ordering` INT(10)   not null ,`title` VARCHAR(1024)  ,`region` VARCHAR(255)  ,`language` VARCHAR(255)  ,`types` VARCHAR(255)  ,`attributes` VARCHAR(1024)  ,`isOriginalTitle` VARCHAR(255)  ,`DI_Create_DT` DATETIME default CURRENT_TIMESTAMP  not null ,primary key(`titleId`,`ordering`))");
						if (log.isDebugEnabled())
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "imdb_title_akas_stg"
						+ "` (`titleId`,`ordering`,`title`,`region`,`language`,`types`,`attributes`,`isOriginalTitle`,`DI_Create_DT`) VALUES (?,?,?,?,?,?,?,?,?)";
...
// ###############################
					...
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append("QUERY" + " = "
									+ "\"SELECT    `imdb_title_akas`.`titleId`,    `imdb_title_akas`.`ordering`,    `imdb_title_akas`.`title`,    `imdb_title_akas`.`region`,    `imdb_title_akas`.`language`,    `imdb_title_akas`.`types`,    `imdb_title_akas`.`attributes`,    `imdb_title_akas`.`isOriginalTitle`,    `imdb_title_akas`.`DI_Create_DT` FROM `imdb_title_akas`\"");
							log4jParamters_tDBInput_1.append(" | ");
							...
							log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM=" + ("false")
									...
									+ ("false") + ", SCHEMA_COLUMN=" + ("language") + "}, {TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("types") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
									+ ("attributes") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
									+ ("isOriginalTitle") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
									+ ("DI_Create_DT") + "}]");
							log4jParamters_tDBInput_1.append(" | ");
				...
				String dbquery_tDBInput_1 = "SELECT \n  `imdb_title_akas`.`titleId`, \n  `imdb_title_akas`.`ordering`, \n  `imdb_title_akas`.`title`, \n  `imdb_title_ak"
						+ "as`.`region`, \n  `imdb_title_akas`.`language`, \n  `imdb_title_akas`.`types`, \n  `imdb_title_akas`.`attributes`, \n  `imdb"
						+ "_title_akas`.`isOriginalTitle`, \n  `imdb_title_akas`.`DI_Create_DT`\nFROM `imdb_title_akas`";
...
// # Output table : 'mysql'
							...
							mysql_tmp.titleId = row1.titleId;
							mysql_tmp.ordering = row1.ordering;
							mysql_tmp.title = row1.title;
							mysql_tmp.region = row1.region;
							mysql_tmp.language = row1.language;
							mysql_tmp.types = row1.types;
							mysql_tmp.attributes = row1.attributes;
							mysql_tmp.isOriginalTitle = row1.isOriginalTitle;
...
// Start of branch "mysql"
						if (mysql != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "mysql", "tMap_1", "tMap_1", "tMap", "tDBOutput_1", "imdb", "tMysqlOutput"
							...
							if (mysql.titleId == null) {
								pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(1, mysql.titleId);
							}

							pstmt_tDBOutput_1.setInt(2, mysql.ordering);

							if (mysql.title == null) {
								pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(3, mysql.title);
							}

							if (mysql.region == null) {
								pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(4, mysql.region);
							}

							if (mysql.language == null) {
								pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(5, mysql.language);
							}

							if (mysql.types == null) {
								pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(6, mysql.types);
							}

							if (mysql.attributes == null) {
								pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(7, mysql.attributes);
							}

							if (mysql.isOriginalTitle == null) {
								pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(8, mysql.isOriginalTitle);
							}

							if (mysql.DI_Create_DT != null) {
								date_tDBOutput_1 = mysql.DI_Create_DT.getTime();
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "mysql", 2, 0, "tMap_1",
						"tMap_1", "tMap", "tDBOutput_1", "imdb", "tMysqlOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "EpV6Yb_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final imdb_title_akas_stg imdb_title_akas_stgClass = new imdb_title_akas_stg();

		int exitCode = imdb_title_akas_stgClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'imdb_title_akas_stg' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'imdb_title_akas_stg' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_nt7O0I_HEe62yM1cY-rR4Q");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-11-30T22:33:40.545679200Z");
		...
		try {
			...
			java.io.InputStream inContext = imdb_title_akas_stg.class.getClassLoader()
					.getResourceAsStream("group14final/imdb_title_akas_stg_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = imdb_title_akas_stg.class.getClassLoader()
		...
		log.info("TalendJob: 'imdb_title_akas_stg' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : imdb_title_akas_stg");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'imdb_title_akas_stg' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 130376 characters generated by Talend Cloud Data Fabric on the November 30,
 * 2023 at 5:33:40 PM EST
 ************************************************************************************************/