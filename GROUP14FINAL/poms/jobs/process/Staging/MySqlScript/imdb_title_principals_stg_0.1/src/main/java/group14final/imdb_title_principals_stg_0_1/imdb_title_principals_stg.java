...
package group14final.imdb_title_principals_stg_0_1;
...
/**
 * Job: imdb_title_principals_stg Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class imdb_title_principals_stg implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "imdb_title_principals_stg.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(imdb_title_principals_stg.class);
	...
	private final String jobName = "imdb_title_principals_stg";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					imdb_title_principals_stg.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(imdb_title_principals_stg.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class mysqlStruct implements routines.system.IPersistableRow<mysqlStruct> {
		final static byte[] commonByteArrayLock_GROUP14FINAL_imdb_title_principals_stg = new byte[0];
		static byte[] commonByteArray_GROUP14FINAL_imdb_title_principals_stg = new byte[0];
		...
		public Boolean charactersIsNullable() {
			return true;
		}

		public Boolean charactersIsKey() {
			return false;
		}

		public Integer charactersLength() {
			return 1024;
		}

		public Integer charactersPrecision() {
			return 0;
		}

		public String charactersDefault() {

			return null;

		}

		public String charactersComment() {
		...
		public String charactersOriginalDbColumnName() {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_GROUP14FINAL_imdb_title_principals_stg.length) {
					if (length < 1024 && commonByteArray_GROUP14FINAL_imdb_title_principals_stg.length == 0) {
						commonByteArray_GROUP14FINAL_imdb_title_principals_stg = new byte[1024];
					} else {
						commonByteArray_GROUP14FINAL_imdb_title_principals_stg = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_GROUP14FINAL_imdb_title_principals_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_imdb_title_principals_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_GROUP14FINAL_imdb_title_principals_stg, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_imdb_title_principals_stg, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_GROUP14FINAL_imdb_title_principals_stg) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "MkRMr1_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBOutput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_1.append("PASS" + " = "
									...
									+ "...");
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"imdb_title_principals\"");
							log4jParamters_tDBOutput_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBOutput_1", "\"imdb_title_principals\"", "tMysqlOutput");
					talendJobLogProcess(globalMap);
				}
				...
				String tableName_tDBOutput_1 = "imdb_title_principals";
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "imdb_title_principals"
						+ "` (`tconst`,`ordering`,`nconst`,`category`,`job`,`characters`,`DI_Create_DT`) VALUES (?,?,?,?,?,?,?)";
...
// ###############################
					...
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append("QUERY" + " = "
									+ "\"SELECT    `imdb_title_principals`.`tconst`,    `imdb_title_principals`.`ordering`,    `imdb_title_principals`.`nconst`,    `imdb_title_principals`.`category`,    `imdb_title_principals`.`job`,    `imdb_title_principals`.`characters`,    `imdb_title_principals`.`DI_Create_DT` FROM `imdb_title_principals`\"");
							log4jParamters_tDBInput_1.append(" | ");
							...
							log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM=" + ("false")
									...
									+ ", SCHEMA_COLUMN=" + ("characters") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
									+ ("DI_Create_DT") + "}]");
							log4jParamters_tDBInput_1.append(" | ");
				...
				String dbquery_tDBInput_1 = "SELECT \n  `imdb_title_principals`.`tconst`, \n  `imdb_title_principals`.`ordering`, \n  `imdb_title_principals`.`nconst`,"
						+ " \n  `imdb_title_principals`.`category`, \n  `imdb_title_principals`.`job`, \n  `imdb_title_principals`.`characters`, \n  `i"
						+ "mdb_title_principals`.`DI_Create_DT`\nFROM `imdb_title_principals`";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							row1.nconst = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
						}
						if (colQtyInRs_tDBInput_1 < 4) {
							row1.category = null;
						} else {

							row1.category = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
						}
						if (colQtyInRs_tDBInput_1 < 5) {
							row1.job = null;
						} else {

							row1.job = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
						}
						if (colQtyInRs_tDBInput_1 < 6) {
							row1.characters = null;
						} else {

							row1.characters = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
						}
						if (colQtyInRs_tDBInput_1 < 7) {
							...
							if (rs_tDBInput_1.getString(7) != null) {
								...
								if (!("0000-00-00").equals(dateString_tDBInput_1)
									...
									row1.DI_Create_DT = rs_tDBInput_1.getTimestamp(7);
								} else {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row1", "tDBInput_1", "\"imdb_title_principals\"", "tMysqlInput", "tMap_1", "tMap_1",
								"tMap"
...
// # Output table : 'mysql'
							...
							mysql_tmp.nconst = row1.nconst;
							mysql_tmp.category = row1.category;
							mysql_tmp.job = row1.job;
							mysql_tmp.characters = row1.characters;
...
// Start of branch "mysql"
						if (mysql != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "mysql", "tMap_1", "tMap_1", "tMap", "tDBOutput_1", "\"imdb_title_principals\"",
									"tMysqlOutput"
							...
							if (mysql.nconst == null) {
								pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(3, mysql.nconst);
							}

							if (mysql.category == null) {
								pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(4, mysql.category);
							}

							if (mysql.job == null) {
								pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(5, mysql.job);
							}

							if (mysql.characters == null) {
								pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(6, mysql.characters);
							}
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tDBInput_1", "\"imdb_title_principals\"", "tMysqlInput", "tMap_1", "tMap_1", "tMap",
						"output")) {
					talendJobLogProcess(globalMap);
				}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "mysql", 2, 0, "tMap_1",
						"tMap_1", "tMap", "tDBOutput_1", "\"imdb_title_principals\"", "tMysqlOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "RbRZIi_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final imdb_title_principals_stg imdb_title_principals_stgClass = new imdb_title_principals_stg();

		int exitCode = imdb_title_principals_stgClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'imdb_title_principals_stg' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'imdb_title_principals_stg' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_0gzEYI_HEe62yM1cY-rR4Q");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-03T21:15:15.778946100Z");
		...
		try {
			...
			java.io.InputStream inContext = imdb_title_principals_stg.class.getClassLoader().getResourceAsStream(
					"group14final/imdb_title_principals_stg_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = imdb_title_principals_stg.class.getClassLoader()
		...
		log.info("TalendJob: 'imdb_title_principals_stg' - Started.");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : imdb_title_principals_stg");
		}
		if (enableLogStash) {
		...
		log.info(
				"TalendJob: 'imdb_title_principals_stg' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 122836 characters generated by Talend Cloud Data Fabric on the December 3,
 * 2023 at 4:15:15 PM EST
 ************************************************************************************************/