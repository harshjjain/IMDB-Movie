...
public class test implements TalendJob {
	...
	public static class mysqlStruct implements routines.system.IPersistableRow<mysqlStruct> {
		final static byte[] commonByteArrayLock_GROUP14FINAL_test = new byte[0];
		static byte[] commonByteArray_GROUP14FINAL_test = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_GROUP14FINAL_test.length) {
					if (length < 1024 && commonByteArray_GROUP14FINAL_test.length == 0) {
						commonByteArray_GROUP14FINAL_test = new byte[1024];
					} else {
						commonByteArray_GROUP14FINAL_test = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_GROUP14FINAL_test, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_test, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_GROUP14FINAL_test, 0, length);
				strReturn = new String(commonByteArray_GROUP14FINAL_test, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_GROUP14FINAL_test) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "VudTsc_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBOutput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_1.append("PASS" + " = "
									...
									+ "...");
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"scd_title_basics\"");
							log4jParamters_tDBOutput_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBOutput_1", "\"scd_title_basics\"", "tMysqlOutput");
					talendJobLogProcess(globalMap);
				}
				...
				String tableName_tDBOutput_1 = "scd_title_basics";
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "scd_title_basics"
						+ "` (`tconst`,`titleType`,`primaryTitle`,`originalTitle`,`isAdult`,`startYear`,`endYear`,`runtimeMinutes`,`genres`) VALUES (?,?,?,?,?,?,?,?,?)";
...
// ###############################
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("HOST" + " = " + "context.imdb_Server");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("PORT" + " = " + "context.imdb_Port");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("DBNAME" + " = " + "context.imdb_Database");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("USER" + " = " + "context.imdb_Login");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("PASS" + " = "
									...
									+ "...");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"imdb_title_basics_stg\"");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("QUERY" + " = "
									+ "\"SELECT    `imdb_title_basics_stg`.`tconst`,    `imdb_title_basics_stg`.`titleType`,    `imdb_title_basics_stg`.`primaryTitle`,    `imdb_title_basics_stg`.`originalTitle`,    `imdb_title_basics_stg`.`isAdult`,    `imdb_title_basics_stg`.`startYear`,    `imdb_title_basics_stg`.`endYear`,    `imdb_title_basics_stg`.`runtimeMinutes`,    `imdb_title_basics_stg`.`genres`,    `imdb_title_basics_stg`.`DI_Create_DT` FROM `imdb_title_basics_stg`\"");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("SPECIFY_DATASOURCE_ALIAS" + " = " + "false");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("PROPERTIES" + " = " + "context.imdb_AdditionalParams");
							log4jParamters_tDBInput_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBInput_1", "\"imdb_title_basics_stg\"", "tMysqlInput");
					talendJobLogProcess(globalMap);
				}
				...
				String dbUser_tDBInput_1 = context.imdb_Login;

				final String decryptedPassword_tDBInput_1 = context.imdb_Password;

				String dbPwd_tDBInput_1 = decryptedPassword_tDBInput_1;

				String properties_tDBInput_1 = context.imdb_AdditionalParams;
				if (properties_tDBInput_1 == null || properties_tDBInput_1.trim().length() == 0) {
					properties_tDBInput_1 = "";
				}
				String url_tDBInput_1 = "jdbc:mysql://" + context.imdb_Server + ":" + context.imdb_Port + "/"
						+ context.imdb_Database + "?" + properties_tDBInput_1;
				...
				String dbquery_tDBInput_1 = "SELECT \n  `imdb_title_basics_stg`.`tconst`, \n  `imdb_title_basics_stg`.`titleType`, \n  `imdb_title_basics_stg`.`primary"
						+ "Title`, \n  `imdb_title_basics_stg`.`originalTitle`, \n  `imdb_title_basics_stg`.`isAdult`, \n  `imdb_title_basics_stg`.`st"
						+ "artYear`, \n  `imdb_title_basics_stg`.`endYear`, \n  `imdb_title_basics_stg`.`runtimeMinutes`, \n  `imdb_title_basics_stg`."
						+ "`genres`, \n  `imdb_title_basics_stg`.`DI_Create_DT`\nFROM `imdb_title_basics_stg`";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row1", "tDBInput_1", "\"imdb_title_basics_stg\"", "tMysqlInput", "tMap_1", "tMap_1",
								"tMap"
...
// Start of branch "mysql"
						if (mysql != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "mysql", "tMap_1", "tMap_1", "tMap", "tDBOutput_1", "\"scd_title_basics\"",
									"tMysqlOutput"
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tDBInput_1", "\"imdb_title_basics_stg\"", "tMysqlInput", "tMap_1", "tMap_1", "tMap",
						"output")) {
					talendJobLogProcess(globalMap);
				}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "mysql", 2, 0, "tMap_1",
						"tMap_1", "tMap", "tDBOutput_1", "\"scd_title_basics\"", "tMysqlOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "wJVpUl_" + subJobPidCounter.getAndIncrement());
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_mtIv8JInEe6WLap09edNWw");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-03T22:03:32.926015300Z");
		...
		try {
			...
			java.io.InputStream inContext = test.class.getClassLoader()
					.getResourceAsStream("group14final/test_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 123825 characters generated by Talend Cloud Data Fabric on the December 3,
 * 2023 at 5:03:32 PM EST
 ************************************************************************************************/